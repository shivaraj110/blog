---
title: "MeNami: Building a Read-Only Web3 Wallet with the Navigator's Eye"
date: "2026-02-04"
tags: ["Web3", "Blockchain", "React", "TypeScript", "Solana", "Ethereum"]
slug: "menami-web3-wallet"
---

*"Money isn't everything, but everything needs money!"* — Nami, One Piece
...
That's where **MeNami** (目ナミ) comes in.

The name combines two powerful concepts:
- **Me (目)** — "Eye" in Japanese
- **Nami (ナミ)** — The legendary navigator and treasurer of the Straw Hat Pirates from One Piece
...
**Read-only** means MeNami is designed purely for viewing and managing keys — it doesn't sign or broadcast transactions. Think of it like Nami carefully counting her treasure without spending unnecessarily. This makes it perfect for:

- 🔍 **Portfolio tracking** across multiple chains
- 🔐 **Cold wallet monitoring** without exposing private keys to hot environments
- 📊 **Account management** for developers testing multi-chain applications
- 🎓 **Learning** about HD wallets and key derivation

## The Tech Crew (Stack)

Building MeNami required assembling the right crew of technologies:

- **Next.js 15** — The ship's hull (app router, React 19)
- **TypeScript** — Type-safe navigation charts
- **Tailwind CSS** — The ship's beautiful paint
- **shadcn/ui** — Pre-built UI components for smooth sailing
- **ethers.js** — Ethereum blockchain interaction
- **@solana/web3.js** — Solana blockchain interaction
- **bip39** — Mnemonic phrase generation and validation
- **ed25519-hd-key** — Solana key derivation (Ed25519 curve)

## Features That Nami Would Approve

✨ **Multi-Chain Treasure** — Manage Solana and Ethereum from a single mnemonic  
...
The foundation of any HD wallet is the mnemonic phrase — your 12-word treasure map. Here's how MeNami generates and validates them:
...
│   ├── OnboardingFlow.tsx   # Create/import wallet
...
1. **Blockchain fundamentals** — Understanding how HD wallets work at a deep level
2. **Cryptography** — Different curves, key derivation paths, and why they matter
3. **Multi-chain development** — Each blockchain has its own quirks and best practices
4. **State management** — Complex state with persistence requirements
5. **Security considerations** — What's acceptable for a demo vs production
...
- 🎨 **Custom token support** (ERC-20, SPL tokens)
- 📊 **Transaction history**
...
Building MeNami was like navigating the Grand Line — challenging, educational, and incredibly rewarding. It's a project born from curiosity about how Web3 wallets work under the hood.

Just like Nami keeps her eye on every berry, MeNami keeps watch over your crypto assets with the same dedication. It's not just a wallet viewer — it's a learning tool, a portfolio tracker, and a testament to the power of open-source development.
...
*"I'll draw a map of the entire world, but first... let me check my wallet balance."* 🗺️💰
...
**Tech Stack:**
Next.js • TypeScript • Tailwind CSS • Solana • Ethereum • Web3

---

*Have questions or suggestions? Feel free to open an issue on GitHub or reach out to me. Happy navigating! ⛵*
